...
<h3 class="m-0 text-dark">Servicios IMTE</h3>
</div>
                    ...
                    <div class="card-body">
                        <form action="" method="post" autocomplete="off" id="formulario">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="precioC" class=" text-dark font-weight-bold">Número de local</label>
                                        <input type="text" placeholder="Ingrese el número de local" class="form-control" name="precioC" id="precioC">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
