...
<h3 class="m-0 text-dark">Sucursales</h3>
</div>
<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" method="post" autocomplete="off" id="formulario">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="laboratorio" class="text-dark font-weight-bold">Sucursal</label>
                                <input type="text" placeholder="Ingrese sucursal" name="laboratorio" id="laboratorio" class="form-control">
                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            ...
                                            <form action="eliminar_sucursal.php?id=<?php echo $data['id']; ?>" method="post" class="confirmar d-inline">
