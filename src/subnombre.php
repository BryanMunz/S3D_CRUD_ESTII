                                ...
                                while ($data = mysqli_fetch_assoc($query)) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 200px;">
                                            ...
                                            <form action="eliminar_subnombre.php?id=<?php echo $data['id']; ?>" method="post" class="confirmar d-inline">
